...
class _ObjectGraphState:
    ...
    def __init__(self, roots: Iterable[object]):
        ...
        from pptx2.opc.package import OpcPackage, Part
        ...
        while stack:
            ...
            if not type(value).__module__.startswith("pptx2.") or not hasattr(value, "__dict__"):
                continue
...
class PackageTransaction:
    ...
    def _internal_targets(self, owner_state: dict) -> list[object]:
        ...
        from pptx2.errors import RelationshipPolicyError, UnsupportedStructureError
