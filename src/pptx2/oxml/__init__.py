...
from pptx2.oxml.ns import NamespacePrefixedTag
...
from pptx2.oxml.action import CT_Hyperlink  # noqa: E402

register_element_cls("a:hlinkClick", CT_Hyperlink)
register_element_cls("a:hlinkHover", CT_Hyperlink)


from pptx2.oxml.chart.axis import (  # noqa: E402
    CT_AxisUnit,
    CT_CatAx,
    CT_ChartLines,
    CT_Crosses,
...
from pptx2.oxml.chart.chart import (  # noqa: E402
    CT_Chart,
    CT_ChartSpace,
    CT_ExternalData,
    CT_PlotArea,
...
from pptx2.oxml.chart.datalabel import CT_DLbl, CT_DLblPos, CT_DLbls  # noqa: E402
...
from pptx2.oxml.chart.legend import CT_Legend, CT_LegendPos  # noqa: E402

register_element_cls("c:legend", CT_Legend)
register_element_cls("c:legendPos", CT_LegendPos)


from pptx2.oxml.chart.marker import CT_Marker, CT_MarkerSize, CT_MarkerStyle  # noqa: E402
...
from pptx2.oxml.chart.plot import (  # noqa: E402
    CT_Area3DChart,
    CT_AreaChart,
    CT_BarChart,
    CT_BarDir,
...
from pptx2.oxml.chart.series import (  # noqa: E402
    CT_AxDataSource,
    CT_DPt,
    CT_Lvl,
    CT_NumDataSource,
...
from pptx2.oxml.dml.fill import (  # noqa: E402
...
from pptx2.oxml.dml.effect import (  # noqa: E402
    CT_BlurEffect,
    CT_EffectList,
    CT_GlowEffect,
...
from pptx2.oxml.dml.three_d import (  # noqa: E402
    CT_Bevel,
    CT_Camera,
    CT_ContourColor,
    CT_ExtrusionColor,
...
from pptx2.oxml.dml.line import CT_PresetLineDashProperties  # noqa: E402
...
from pptx2.oxml.shapes.autoshape import (  # noqa: E402
    CT_AdjPoint2D,
    CT_CustomGeometry2D,
    CT_GeomGuide,
    CT_GeomGuideList,
...
from pptx2.oxml.shapes.connector import (  # noqa: E402
    CT_Connection,
    CT_Connector,
...
from pptx2.oxml.shapes.graphfrm import (  # noqa: E402
    CT_GraphicalObject,
...
from pptx2.oxml.shapes.groupshape import (  # noqa: E402
    CT_GroupShape,
...
from pptx2.oxml.shapes.picture import CT_Picture, CT_PictureNonVisual  # noqa: E402
...
from pptx2.oxml.shapes.shared import (  # noqa: E402
...
from pptx2.oxml.slide import (  # noqa: E402
    CT_Background,
...
from pptx2.oxml.table import (  # noqa: E402
    CT_Table,
    CT_TableCell,
...
from pptx2.oxml.theme import CT_OfficeStyleSheet  # noqa: E402
