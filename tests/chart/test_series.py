...
"""Unit-test suite for `pptx2.chart.series` module."""
...
from pptx2.chart.series import (
    AreaSeries,
    BarSeries,
    BubbleSeries,
    LineSeries,
...
class Describe_BaseSeries(object):
    ...
    def ChartFormat_(self, request, chart_format_):
        return class_mock(request, "pptx2.chart.series.ChartFormat", return_value=chart_format_)
...
class Describe_BaseCategorySeries(object):
    ...
    def CategoryPoints_(self, request, points_):
        return class_mock(request, "pptx2.chart.series.CategoryPoints", return_value=points_)

    @pytest.fixture
    def DataLabels_(self, request):
        return class_mock(request, "pptx2.chart.series.DataLabels")
...
class Describe_MarkerMixin(object):
    ...
    def Marker_(self, request, marker_):
        return class_mock(request, "pptx2.chart.series.Marker", return_value=marker_)
...
class Describe_BubbleSeries(object):
    ...
    def BubblePoints_(self, request, points_):
        return class_mock(request, "pptx2.chart.series.BubblePoints", return_value=points_)
...
class Describe_XySeries(object):
    ...
    def XyPoints_(self, request, points_):
        return class_mock(request, "pptx2.chart.series.XyPoints", return_value=points_)
...
class DescribeSeriesCollection(object):
    ...
    def _SeriesFactory_(self, request, series_):
        return function_mock(request, "pptx2.chart.series._SeriesFactory", return_value=series_)
...
class Describe_SeriesFactory(object):
    ...
    def call_fixture(self, request):
        ...
        SeriesCls_ = class_mock(request, "pptx2.chart.series.%s" % cls_name)
