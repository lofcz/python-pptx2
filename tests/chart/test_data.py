...
"""Test suite for `pptx2.chart.data` module."""
...
from pptx2.chart.xlsx import CategoryWorkbookWriter
...
class Describe_BaseChartData(object):
    """Unit-test suite for `pptx2.chart.data._BaseChartData`."""
    ...
    def ChartXmlWriter_(self, request):
        ChartXmlWriter_ = class_mock(request, "pptx2.chart.data.ChartXmlWriter")
        ChartXmlWriter_.return_value.xml = "ƒøØßår"
...
class DescribeCategoryChartData(object):
    ...
    def Categories_(self, request, categories_):
        return class_mock(request, "pptx2.chart.data.Categories", return_value=categories_)

    @pytest.fixture
    def CategorySeriesData_(self, request, series_):
        return class_mock(request, "pptx2.chart.data.CategorySeriesData", return_value=series_)
...
class DescribeCategories(object):
    ...
    def Category_(self, request, category_):
        return class_mock(request, "pptx2.chart.data.Category", return_value=category_)
...
class DescribeCategory(object):
    ...
    def add_sub_fixture(self, request, category_):
        ...
        name = "foobar"
        Category_ = class_mock(request, "pptx2.chart.data.Category", return_value=category_)
...
class DescribeCategorySeriesData(object):
    ...
    def CategoryDataPoint_(self, request, data_point_):
        return class_mock(request, "pptx2.chart.data.CategoryDataPoint", return_value=data_point_)
...
class DescribeBubbleChartData(object):
    ...
    def BubbleSeriesData_(self, request, series_data_):
        return class_mock(request, "pptx2.chart.data.BubbleSeriesData", return_value=series_data_)
...
class DescribeXyChartData(object):
    ...
    def XySeriesData_(self, request, series_data_):
        return class_mock(request, "pptx2.chart.data.XySeriesData", return_value=series_data_)
...
class DescribeBubbleSeriesData(object):
    ...
    def BubbleDataPoint_(self, request, data_point_):
        return class_mock(request, "pptx2.chart.data.BubbleDataPoint", return_value=data_point_)
...
class DescribeXySeriesData(object):
    ...
    def XyDataPoint_(self, request, data_point_):
        return class_mock(request, "pptx2.chart.data.XyDataPoint", return_value=data_point_)
