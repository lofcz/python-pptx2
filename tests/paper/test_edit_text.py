"""Contract tests: anchored, formatting-preserving text replacement (pptx2.edit).
...
from pptx2.edit import ReplaceResult, refind, replace_text, replace_text_at
...
from pptx2.inspect import BlockAnchor, content_hash, inspect_text
...
def test_replace_text_rolls_back_after_a_late_mutation(monkeypatch):
    import pptx2.edit as edit_module
